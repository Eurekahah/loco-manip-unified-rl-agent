...
class HighLevelRoughEnvCfg(HighLevelEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.arm_camera.prim_path = "{ENV_REGEX_NS}/Robot/" + self.arm_camera_link_name
        self.scene.nav_camera.prim_path = "{ENV_REGEX_NS}/Robot/" + self.nav_camera_link_name
