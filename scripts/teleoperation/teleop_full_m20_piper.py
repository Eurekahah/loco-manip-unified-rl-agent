...
from rl_training.devices.keyboard_full import Se2KeyboardFull, Se2KeyboardFullCfg
...
def main():
    ...
    # L 键 → 重置环境（Se2KeyboardFull 内部 L 已 reset 命令向量，此处额外 reset env）
